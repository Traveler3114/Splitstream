...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_LockPick_PinConfirmed);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ability_Hack_Complete);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ability_Search_Complete);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Effect_Timer);
